...
public class ScoreHelvetica : MonoBehaviour
{
	...
	void Update()
	{
		Text = "Goal:" + GameObject.Find("ScoreBox").GetComponent<ScoreManager>().score + "/" + GameObject.Find("ScoreBox").GetComponent<ScoreManager>().total;
		GenerateText();
	}
